...
<form method="post" action="countries.php" name="myform">
    <label for="formCountry">Выберите страну:</label>
    ...
    <input type="range" class="price" id="price" name="price" min="100" max="10000" step="50" oninput="outputRange.value = this.value">
    <output id="outputRange" class="price" for="price">5000</output><br><br>
    
    <label class="form-label" for="transport">Выберите транспорт:</label>
    ...
    <label for="stars" class="form-label">Звезды (от 1 до 5):</label>
